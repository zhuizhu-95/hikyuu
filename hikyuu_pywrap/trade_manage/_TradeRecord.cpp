...
void export_TradeRecord(py::module& m) {
    ...
    py::class_<TradeRecord>(m, "TradeRecord", "交易记录")
      ...
      .def_readwrite("datetime", &TradeRecord::datetime, "交易时间")
      .def_readwrite("business", &TradeRecord::business, "业务类型")
      .def_readwrite("planPrice", &TradeRecord::planPrice, "计划交易价格")
      .def_readwrite("realPrice", &TradeRecord::realPrice, "实际交易价格")
      .def_readwrite("goalPrice", &TradeRecord::goalPrice, "目标价位")
